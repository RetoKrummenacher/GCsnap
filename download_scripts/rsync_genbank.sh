#!/bin/bash
# Synchronize with the NCBI GenBank databases
...
# nohup ./download_scripts/rsync_genbank.sh >/dev/null 2>&1 &

export WORK_DIR="/scicore/home/schwede/GROUP/gcsnap_db/genbank"
# Define the folder for rsync files
export DESTINATION="$WORK_DIR/data"
# prefix of Database
export PREFIX="GCA"
# summary name
SUMMARY_NAME="assembly_summary_genbank.txt"
# URL for summary
SUMMARY_URL="https://ftp.ncbi.nlm.nih.gov/genomes/genbank/$SUMMARY_NAME"
...
# This part is not very efficient, moving to tmp folder and deleting there might be faster
# or even done in parallel
rm ${DESTINATION}/.${PREFIX}* 2>/dev/null
